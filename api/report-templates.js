...
export function buildReportHtml(data) {
  ...
  sections.push(`
    <div style="text-align:center;margin:36px 0 24px 0;padding:28px 20px;background:${S.cardBg};border-radius:12px;border:1px solid ${S.border};">
      ...
      <a href="https://calendly.com/epiphanydynamics/ai-workflow-review-call" style="display:inline-block;background:${S.text};color:${S.bg};padding:14px 32px;border-radius:100px;text-decoration:none;font-weight:700;font-size:15px;">Book your free call</a>
    </div>
  `)
