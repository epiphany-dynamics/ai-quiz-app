# AI Readiness Quiz — Report Copy Blocks
> Review this file. Once approved, these blocks get assembled into HTML email templates.
> Each user gets ONE report based on their tier + personalized sections based on their answers.

---

## BUSINESS TRACK REPORTS
...
3. **Get an operations intelligence dashboard** — Stop running your business on gut feel and end-of-month spreadsheets. An AI-generated weekly report surfaces your top revenue drivers, customer patterns, and staff performance without any data entry.
...
- **"Onboarding new clients or staff"** — AI onboarding assistants answer new hire or new client questions instantly, walk them through procedures, and flag issues to you only when a human is needed. This scales your onboarding capacity without adding headcount.
...
### Tier 2: AI-Curious Builder (score 56-83)

**Headline:** You see the value. Here's the clearest path in.

**Summary paragraph:**
You're not starting from zero. You've used AI tools, you have real business systems in place, and you can identify what's costing you time. The gap between where you are and meaningful automation isn't knowledge -- it's picking the right first move. This report gives you that move.
...
"Here's what businesses like yours are doing with AI right now:"

*[Then the same industry-specific paragraph from Tier 1.]*

**Section: Personalized by pain points**
*[Same pain point blocks as Tier 1.]*
...
**Section: Personalized by industry**
*[Same industry blocks but with this intro sentence:]*

"Here's what's working for businesses in your industry right now -- no technical knowledge required:"
...
- **Professional services:** Start with an AI-powered contact form that qualifies leads and books discovery calls automatically. Prospective clients answer a few questions, get matched to the right service, and book directly on your calendar without back-and-forth emails.

- **E-commerce:** Start with an AI chat widget that handles the top 10 customer questions (shipping times, return policy, order status). It reduces support tickets immediately and makes your store feel more professional.
...
- **"I tried it once and it didn't work well"** — The tools have changed dramatically in the last 12 months. What didn't work a year ago probably works now. The difference is usually in the setup -- AI needs to be configured for your specific business, not used out of the box.

- **"I just haven't had time"** — That's the most common answer, and it's also the most expensive one. Every week you spend doing tasks AI could handle is a week of lost capacity. The audit call takes 30 minutes and gives you a plan you can act on when you're ready.
...
**Section: Personalized by barrier**
*[Same barrier blocks as Tier 3 -- only shown if A6a was answered.]*
...
1. **Build your own personal AI workflows** — Chain multiple AI tools together. Claude for drafting, Zapier for routing, Notion AI for organizing. Automate multi-step tasks that most people still do manually.
...
- **"Managing my inbox"** — You're ready for email triage automation. Tools like Superhuman AI or Claude-powered email workflows can categorize, draft replies, and flag priority messages. The goal is inbox zero without the effort.

- **"Meal planning and recipes"** — You'd get real value from a custom Claude Project trained on your dietary preferences, household size, and cooking skill level. Ask it to generate weekly meal plans with grocery lists. It gets better every time you use it.

- **"Scheduling and reminders"** — Look into AI calendar assistants (Reclaim AI, Clockwise) that optimize your schedule based on your priorities, energy levels, and meeting patterns. They're a level up from basic calendar apps.

- **"Research and summarization"** — You're ready for advanced research workflows. Use Claude to summarize long documents, compare sources, and extract specific data points. Build a prompt library for your most common research tasks.

- **"Creative work"** — Explore multi-modal AI workflows: Claude or ChatGPT for ideation and writing, Midjourney or DALL-E for visual concepts, and tools like Descript for audio/video editing. Chain them together for a full creative pipeline.

**Section: Personalized by learning style (G8)**

- **"YouTube video"** — Follow channels like "AI Explained," "Matt Wolfe," or "All About AI" for advanced workflows. Skip the beginner content and search for "advanced Claude prompting" or "AI automation workflows."

- **"Just open it and click around"** — Challenge yourself: pick one task you do every week and refuse to do it manually. Force yourself to build an AI workflow for it. The constraint is the teacher.

- **"Read a guide"** — Subscribe to "The Rundown AI" or "Superhuman AI" newsletters. They're curated, fast, and focused on practical use cases, not hype.

- **"Have someone walk me through it"** — Find one AI-focused community (Discord, Reddit, or a local meetup). The live conversations are more current than any course.

- **"Watch someone first"** — Follow 2-3 AI power users on Twitter/X. Watch their workflows, then copy and adapt until it fits yours.

**Section: What to do this week**

1. Pick one repetitive task you still do manually and build an AI workflow for it this week. Not someday. This week.
2. If you haven't already, create a Custom GPT or Claude Project for your most common use case. Invest 20 minutes upfront to save hours going forward.
3. Show one friend or colleague the most useful thing you've done with AI this month. Teaching locks in your own understanding.

---

### Tier 2: The Explorer (score 56-83)

**Headline:** You're closer to fluent than you think. Here's the bridge.

**Summary paragraph:**
You're not a beginner. You use AI tools, you're interested in what's new, and you've built some real comfort. The gap between where you are and genuinely fluent isn't skill -- it's consistency. You're one good daily habit away from wondering how you ever managed without AI. This report gives you the habit.
...
- **"Managing my inbox"** — Start simple: when you get an email that requires a long response, paste it into Claude and say "help me draft a reply that's professional and concise." Do this for one week and you'll cut your email time in half.

- **"Meal planning and recipes"** — Try this prompt: "I have [list ingredients]. Give me 3 dinner options that take under 30 minutes." Use it once and you'll use it every week.

- **"Scheduling and reminders"** — Ask Claude to help you build a weekly schedule template. Describe your priorities, constraints, and energy patterns. It'll create a structure you can reuse.

- **"Research and summarization"** — Next time you need to research something, paste the top 3 articles into Claude and ask "summarize the key points and tell me what they agree and disagree on." Faster and more useful than reading all three.

- **"Creative work"** — Use AI as a brainstorming partner, not a replacement. Start every creative task by asking Claude for 10 ideas, pick the 2 best, then develop them yourself. The combination is better than either alone.

**Section: Personalized by learning style (G8)**
*[Same blocks as Trailblazer.]*

**Section: What to do this week**

1. Pick ONE task you do every week and commit to using AI for it every time this month. Not occasionally. Every time. Consistency builds fluency.
2. Save your best prompts somewhere -- a note, a doc, anywhere. Start your prompt library with the 5 prompts that have saved you the most time so far.
3. If you haven't tried voice mode, download Claude or ChatGPT on your phone and use voice for your next three AI interactions. It changes the experience completely.

---

### Tier 3: The Thoughtful Skeptic (score 22-55)

**Headline:** Your skepticism is healthy. Here's the evidence.

**Summary paragraph:**
You're not sold on AI, and that's a reasonable position given the amount of hype out there. But there's a difference between healthy skepticism and missing something that could genuinely save you time. You don't need to love AI. You just need one experience that proves it's useful for you specifically. This report gives you that experience.
...
**Section: Personalized by hesitation (G7)**
*[Shown only if G7 was answered -- only for skeptics/anxious users]*
...
### Tier 4: The Fresh Start (score 0-21)

**Headline:** The best time to start is now. Here's exactly how.

**Summary paragraph:**
You're at the very beginning with AI, and that's genuinely a great place to be right now. The people who started two years ago spent most of that time experimenting with tools that were half-baked. You get to skip straight to what actually works. This report gives you three concrete things to try -- no jargon, no pressure, no prior knowledge needed.
...
**Section: Personalized by wishlist (G5)**
*[Ultra-simple versions]*

- **"Managing my inbox"** — Go to claude.ai. Paste an email you need to reply to. Type "help me write a polite response." Done. That's AI for email.

- **"Meal planning"** — Go to claude.ai. Type "plan 5 dinners for this week for 2 people, nothing takes over 30 minutes, include a grocery list." That's AI for meal planning.

- **"Scheduling"** — Go to claude.ai. Type "I have these 5 things to do this week [list them]. Help me figure out the best order and when to do each one." That's AI for scheduling.

- **"Research"** — Go to claude.ai. Paste a link or copy text from something you need to read. Type "summarize the key points in 3 bullets." That's AI for research.

- **"Creative stuff"** — Go to claude.ai. Type "I need to write a [social post / birthday message / thank you note / whatever]. Here's the context: [describe it]." That's AI for creative work.

**Section: Personalized by learning style (G8)**

- **"YouTube video"** — Search YouTube for "Claude AI for beginners" or "ChatGPT for beginners 2026." There are excellent 10-minute walkthroughs that make the whole thing click.

- **"Just open it and click around"** — Go to claude.ai right now. Type anything. Seriously. The best intro to AI is using it, not reading about it.

- **"Read a guide"** — Google "how to use Claude AI" -- the official getting started guide is simple and practical. 15 minutes of reading gives you everything you need to start.

- **"Have someone walk me through it"** — Ask someone you know who uses AI to spend 10 minutes showing you their setup. That single conversation is worth more than any tutorial.

- **"Watch someone first"** — Search YouTube for "how I use AI every day." Watching a real person's daily use makes AI feel practical instead of abstract.

**Section: What to do this week**

1. Go to claude.ai. Type one thing. Anything. The first conversation is the hardest part, and it takes 30 seconds.
2. If you liked the result, try it again tomorrow with something different. Two good experiences and the hesitation disappears.
3. If you want a real person to show you the ropes, book a free 15-minute call. We'll walk you through the one thing that's most useful for your specific life -- not a sales pitch, just a helpful conversation.

---

## CTA BLOCK (appears at the bottom of every report)

**Headline:** Want to go deeper?

**Body:** This report is based on your quiz answers, but a 15-minute conversation can go much further. We'll map AI specifically to your situation -- your industry, your team, your biggest time drain -- and give you a prioritized action plan.

**Button text:** Book your free call

**Button link:** https://epiphanydynamics.ai/book

**Footer:** Built by Epiphany Dynamics -- AI Automation for Modern Business | epiphanydynamics.ai
